...
Implement perceptron algorithm with stochastic gradient descent for the adult income dataset using Python. Experiment with performance as a function of learning rate.

NOTE: below contains a very detailed version of how the algorithm works. If you already have knowledge of how Perceptron works, I suggest you read the code instead!
